...
class DMV(object):
    def __init__(self, args):
        print('LOG->-modules/dmv_viterbi_model.py: DMV(object).__init__')
        self.end_symbol = 'END'
        self.tita = None
    ...
    def init_params(self, train_tags, tag_set):
        print('LOG->-modules/dmv_viterbi_model.py: DMV(object).init_params(self, train_tags, tag_set)')
        ...
        for i, s in enumerate(filter(lambda s: len(s) > 1, \
            ...
            parse_tree, prob = self.dep_parse(s) #convert formato CONLLU para formato de árvore
    ...
    def eval(self, gold, tags, all_len=False):
        ...
        """
        print('LOG->-modules/dmv_viterbi_model.py: eval(')
        ...
        return (dir_acu, undir_acu,parse)
    ...
    def dep_parse(self, s):
        ...
        #    print('(1/10) modules/dmv_viterbi_model.py: DMV(object).dep_parse(self, %s)' % s)
